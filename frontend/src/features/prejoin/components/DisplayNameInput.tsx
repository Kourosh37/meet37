...
File: src\features\prejoin\components\DisplayNameInput.tsx
Layer: Pre-Join

Responsibility:
- Frontend file for the Pre-Join layer. It should implement only the responsibility implied by its route/feature name and should stay aligned with frontend-architecture.md.
...
// - Collect the required display_name for WebSocket join.
// - Pre-fill from the last display name when product policy allows.
