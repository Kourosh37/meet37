...
File: src\features\meeting\workers\statsWorker.ts
...
// Stats worker placeholder.
//
// Planned responsibilities:
// - Move expensive WebRTC stats aggregation out of the UI thread when needed.
// - Produce bitrate, packet loss, and RTT reports.
