...
File: src\features\meeting\hooks\useModeration.ts
...
// - Send approve, reject, mute, and kick commands as host-only actions.
// - Reflect remote moderation results in meeting state.
