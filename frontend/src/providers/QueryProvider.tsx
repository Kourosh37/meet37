...
Responsibility:
- Frontend file for the Application Providers layer. It should implement only the responsibility implied by its route/feature name and should stay aligned with frontend-architecture.md.
...
// - Create and provide the TanStack Query client.
// - Centralize default stale times and retry behavior.
