...
export const roomPasswordSchema = z.string().max(256, "Password is too long").optional();
...
export const roomCreationSchema = z.object({
  name: z.string().trim().min(1, "Room name is required").max(120, "Room name is too long"),
