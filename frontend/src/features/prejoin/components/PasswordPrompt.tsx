...
File: src\features\prejoin\components\PasswordPrompt.tsx
Layer: Pre-Join
...
// Password prompt placeholder.
//
// Planned responsibilities:
// - Collect room password for password-protected rooms.
// - Keep the password scoped to the join attempt.
