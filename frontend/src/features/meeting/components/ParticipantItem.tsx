...
File: src\features\meeting\components\ParticipantItem.tsx
...
// - Show participant identity, host badge, mute state, and quality indicator.
// - Provide host moderation entry points when allowed.
