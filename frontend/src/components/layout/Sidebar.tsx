...
Responsibility:
- Frontend file for the Layout Shell layer. It should implement only the responsibility implied by its route/feature name and should stay aligned with frontend-architecture.md.
...
// - Provide navigation between admin dashboard, users, and SFU stats.
// - Collapse responsively for tablet/mobile.
// - Preserve keyboard navigation and active route indication.
