...
// Room password modal placeholder.
//
// Planned responsibilities:
// - Prompt for room password only when room metadata says one is required.
// - Return the password to the prejoin flow without persisting it globally.
