...
File: src\types\env.d.ts
Layer: Shared Types

Responsibility:
- Frontend file for the Shared Types layer. It should implement only the responsibility implied by its route/feature name and should stay aligned with frontend-architecture.md.
