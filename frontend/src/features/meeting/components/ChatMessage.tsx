...
File: src\features\meeting\components\ChatMessage.tsx
...
// Chat message row placeholder.
//
// Planned responsibilities:
// - Render display name, timestamp, and escaped text.
// - Support history and live WebSocket messages with the same UI.
